...
unzip 814712_MTL_TuneD_Static_Profile_RN_Rev1p2.zip && cd 814712_MTL_TuneD_Static_Profile_RN_Rev1p2 && unzip pkg.OPT.EPPprofile-1.05.240206.1-x86_64.zip && cd pkg.OPT.EPPprofile-1.05.240206.1-x86_64 && sudo dnf install tuned -y && sh deploy.sh && sudo dnf install -y python3-gobject python3-cairo gobject-introspection gtk3 libappindicator-gtk3 tuned
